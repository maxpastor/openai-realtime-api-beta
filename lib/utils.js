...
export class RealtimeUtils {
  ...
  static mergeInt16Arrays(left, right) {
    ...
    // Utilise la méthode set pour éviter les boucles explicites
    newValues.set(left, 0); // Copie le premier tableau à partir de l'index 0
    newValues.set(right, left.length); // Copie le second tableau après le premier
